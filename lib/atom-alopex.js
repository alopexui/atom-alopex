...
//    };
 ...
 createAlopexTemplateB(e){
   ...
   if(elClass.indexOf('directory') != -1){
     ...
     this.downloadAndExtractFile(ALOPEX_HOME+"2.3/publishing/alopex-ui-templateB.zip","alopex-ui-templateB.zip",extractDest,true)
   }else{
     atom.notifications.addError ('An error has ocurred',{
       detail: "Template destination is not directory, you must select directory!",
       dismissable: true
 ...
 createAlopexTemplateC(e){
   ...
   if(elClass.indexOf('directory') != -1){
     ...
     this.downloadAndExtractFile(ALOPEX_HOME+"2.3/publishing/alopex-ui-templateC.zip","alopex-ui-templateC.zip",extractDest,true)
   }else{
     atom.notifications.addError ('An error has ocurred',{
       detail: "Template destination is not directory, you must select directory!",
       dismissable: true
 ...
 createAlopexTemplateD(e){
   ...
   if(elClass.indexOf('directory') != -1){
     ...
     this.downloadAndExtractFile(ALOPEX_HOME+"2.3/publishing/alopex-ui-templateD.zip","alopex-ui-templateD.zip",extractDest,true)
   }else{
     atom.notifications.addError ('An error has ocurred',{
       detail: "Template destination is not directory, you must select directory!",
       dismissable: true
 ...
 createAlopexTemplateE(e){
   ...
   if(elClass.indexOf('directory') != -1){
     ...
     this.downloadAndExtractFile(ALOPEX_HOME+"2.3/publishing/alopex-ui-templateE.zip","alopex-ui-templateE.zip",extractDest,true)
   }else{
     atom.notifications.addError ('An error has ocurred',{
       detail: "Template destination is not directory, you must select directory!",
       dismissable: true
