          ...
          <div className='welcome-consent'>
            ...
            <section className='welcome-panel'>
              ...
              <div className='welcome-consent-choices'>
                <div>
                  <a href="https://ui.alopex.io" target="_blank"><button className='btn'>Alopex UI Home</button></a>
                </div>
                <div>
                  <a href="https://grid.alopex.io" target="_blank"><button className='btn'>Alopex Grid Home</button></a>
                </div>
                <div>
